# ethash-kernels
For whatever reason, Zawawawa released his Ethash kernels as open source code. This repo is a verbaitm copy of that code with a simplistic build environment and [nsfminer](https://github.com/miscellaneousbits/nsfminer) as a target. Although the code for Ethminer has yet to be released.
